#ifndef CSGOINTERNAL_TRACERAYUTIL_H
#define CSGOINTERNAL_TRACERAYUTIL_H
...
struct Ray_t
{
	...
	const void* m_pWorldAxistTransform;
	bool	m_IsRay;	// are the extents zero?
	bool	m_IsSwept;	// is delta != 0?

	Ray_t() : m_pWorldAxistTransform(NULL) {}
...
public:
	...
	virtual void TraceRay(const Ray_t &Ray, unsigned int fMask, ITraceFilter *TraceFilter, CGameTrace *pTrace) = 0;
};

/// TraceLine Flags
typedef void(__fastcall* tTraceRay)(void* thisptr, void* not_edx, Ray_t &Ray, unsigned int fMask, ITraceFilter *TraceFilter, CGameTrace *PTrace);

/// TraceRay Function
bool TraceRayFunction(uintptr_t Ent);

#endif //CSGOINTERNAL_TRACERAYUTIL_H